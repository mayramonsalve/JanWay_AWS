...
namespace JWA.Auth
{
    ...
    {
        public const string InviteEmailTemplate = "<html>< head ></ head >< body >< img src='' width='500' height='+600+'><a href = 'www.w3schools.com' > Visit website ></a><h1>Welcome to JanWay</h1></br><p>Lorem ipsum dolor sirt amet consectetur adipiscing elit laoreet, dapibus nunc bibendum scelerisque litora erat mollis egestas quisque justo curabitur.</p></br><a href = '{0}' > START HERE</a></body></html>";
        public const string RecoverPasswordEmailTemplate = "PasswordResetToken={0}";
        public const string InviteEmailSubject = "Invite to collaborate with JanWay - {0}";
        public const string RecoverEmailSubject = "Password recovery";
        ...
        public const string SendGridKey = "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";
    }
}
